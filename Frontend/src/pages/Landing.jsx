  ...
  return (
    <div className="relative bg-zinc-950 text-white overflow-hidden">
      ...
      <section className="relative h-[80vh] flex items-center justify-center pt-[-40px]">
        ...
        <div className="relative text-center z-10 px-6 animate-fadeIn -mt-24">
          ...
          <button
            ...
            className="bg-amber-400 text-black px-8 py-4 rounded-lg font-bold hover:bg-amber-500 transition duration-300 hover:scale-105 shadow-lg"
          >
            Explore Vehicles
          </button>
        </div>
      ...
      <section className="px-8 py-24">
        ...
        <div className="grid md:grid-cols-3 gap-8 bg-white/5">
          <div
            onClick={() => navigate("/vehicles")}
            className="md:col-span-2 cursor-pointer hover:scale-105 transition"
          >
            <FeaturedCard
      ...
      <section className="px-8 pb-28">
        <div className="bg-gradient-to-r from-zinc-900 to-zinc-800 rounded-2xl flex flex-col md:flex-row justify-between items-center px-12 py-16 gap-8">
          ...
          <button
            onClick={() => navigate("/vehicles")}
            className="bg-amber-400 text-black px-8 py-4 rounded-lg font-bold hover:bg-amber-500 transition duration-300"
          >
            Browse Collection
          </button>
        </div>
